...
| 代理 | 详细信息 | 支持的应用程序 |
| --- | --- | --- |
|  [!DNL Microsoft 365 Copilot][&#128279;](ama-ms.md)的Adobe Marketing Agent | 即时检索[!DNL Microsoft 365]应用（如[!DNL Teams]、[!DNL Word]、[!DNL Powerpoint]和[!DNL Excel]）中Adobe Experience Platform的营销分析。 通过此代理，您可以跨应用程序维护聊天历史记录，并在工作时无缝地继续对话。 | |
